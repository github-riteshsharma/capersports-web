        ...
        {isHovered && (
          ...
          >
              ...
              <div className="mb-3">
                ...
                <div className="flex flex-wrap gap-2">
                  {product.sizes.map((size, index) => {
                    ...
                    const stockValue = typeof size === 'object' && size.stock !== undefined ? size.stock : 10;
                    ...
                    if (typeof sizeName === 'object') {
                      console.warn('Size is still an object:', sizeName);
                      return null;
                    }
            ...
            <motion.button
              ...
              className="w-full bg-gray-900 hover:bg-gray-800 disabled:bg-gray-400 text-white py-3 px-4 rounded-lg font-medium transition-colors duration-200 flex items-center justify-center space-x-2 disabled:cursor-not-allowed dark:bg-white dark:text-gray-900 dark:hover:bg-gray-100"
            >
              {isLoading ? (
